...
import cat.dcat.util.Helper_KtKt;
...
public class ChromaPack {
    ...
    public static BufferedImage decodeBackground(BufferedImage image, boolean isGray, boolean removeBolder, float b) {
        int tw = image.getWidth();
        int th = image.getHeight();
        BufferedImage out = new BufferedImage(tw, th, BufferedImage.TYPE_4BYTE_ABGR);
        Helper_KtKt.dlog("size(x,y):(" + tw + "   " + th);
            ...
            for (int y = 0; y < th; y++) {
                try {
                    ...
                    * */
                    ...
                    float alpha_ = 1f;
                    if (removeBolder) {
                        if ((x < tw * b || x > tw * (1f - b)) || (y < th * b || y > th * (1f - b))) {
    ...
    public static BufferedImage decodeUnitImage(BufferedImage image, boolean isGray) {
    ...
    public static void main(String[] args) throws IOException {
        args = new String[]{"-a", "tmp/1280.png"};
        ...
        for (String source : sources) {
            ...
            if (hasAlpha)
                ...
                outImage = decodeBackground(image, isGray, removeBolder, 0.1f);
    ...
    public static BufferedImage zoomImage(BufferedImage originalImage, int width, int height) {
        ...
        g.drawImage(originalImage.getScaledInstance(width, height, Image.SCALE_AREA_AVERAGING), 0, 0, width, height, null);
        g.dispose();
        return newImage;
    }
